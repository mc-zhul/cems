...
<head>
	...
	<%@include file="jsp/common/skin1/include.jsp"%>
...
<body class="login-background">
	<div id="login-box">
	    ...
	    <div id="login-foot">
	         <div style="text-align:center;color:#4e86b0;">VERSION MANAGE SYSTEM	杭州美创科技有限公司	 版权所有	©<br />	推荐IE8浏览器,1024*768或以上分辨率</div>
	    </div>
    </div>
</body>
</html>
